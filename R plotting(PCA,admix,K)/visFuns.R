...
plotAdmix <- function(q, pop=NULL, ord=NULL, inds=NULL,
                      colorpal= c("#E41A1C", "#377EB8", "#4DAF4A", "#984EA3", "#FF7F00", "#FFFF33", "#A65628", "#F781BF", "#999999","#A6CEE3","#1F78B4","#B2DF8A","#33A02C","#FB9A99","#E31A1C","#FDBF6F","#FF7F00","#CAB2D6","#6A3D9A","#FFFF99","#B15928","#1D4F9F","#BFF217","#60D5FD","#CC1577","#FF9326","#DF0101","#EC496F","#326397","#B26314","#027368","#A4A4A4","#610B5E"),
  ...
  # Generate 100 distinct colors using colorRampPalette
  additional_colors <- colorRampPalette(c("blue", "green", "orange", "purple", "pink"))(100)
  
  colorpal <- c(colorpal, additional_colors)
